...
class componenteApp extends Component {
    ...
    //eventp o metodo para  insserta y o actulizar una tarea, que hace una peticion al servidor por metodo POST para insertar o por metodo PUT para actualizar
             ...
             <div>
                <div className="row fondoDiv3 ">
                    <div className="col-12">
                        <h1>Operaciones CRUD with Django...</h1>
